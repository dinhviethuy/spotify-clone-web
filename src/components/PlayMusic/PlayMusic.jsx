...
import {FaBackwardStep, FaCirclePlay, FaShuffle, FaVolumeHigh} from "react-icons/fa6";
import {BsLaptop, BsRepeat} from "react-icons/bs";
    ...
    <>
      <div className='play'>
        <div className='box'>
          ...
          <div className="title">
            <span className='title-music'>Music Title</span>
        ...
        <div className='box-play'>
          ...
          <div className="slider">
            <span><b>2:11</b></span>
            <div className="w-[70%] h-1 bg-gray-700 rounded-full">
              <div className="bg-gray-300 h-1 rounded-full" style={{width: "70%"}}></div>
            </div>
            <span><b>2:42</b></span>
          </div>
        </div>
        <div className='box-icon-right items-center'>
          <FaShuffle/>
          <BsLaptop className='text-green-500' />
          <FaVolumeHigh />
          <div className="w-[40%] h-1 bg-gray-700 rounded-full">
            <div className="bg-gray-300 h-1 rounded-full" style={{width: "70%"}}></div>
          </div>
          <CgArrowsExpandRight />
        </div>
